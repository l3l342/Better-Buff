...
class App(customtkinter.CTk):
    ...
    def search(self):
        ...
        #graphic_image_item="2bild.jpg" #hier schauenwoher grafik
        ...
        self.skin_image.grid(row=1, column=0, padx=80, pady=(160, 160), sticky="")
